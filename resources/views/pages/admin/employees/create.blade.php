...
<div class="mx-10 my-10 bg-white p-6">
    <x-utilities.title>Criar Colaborador</x-utilities.title>
    <form action="{{ route('admin.employees.store') }}" method="POST" class="space-y-6 mt-16">
        @csrf
        <div class="form-group grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 md:gap-6">
        ...
        <div class="form-group grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 md:gap-6">
            <div class="relative w-full">
                <x-form.input
                    type="password"
                    id="password"
                    name="password"
                />
                <x-form.label for="password">Palavra-passe <span class="text-pawx-orange">*</span>
                </x-form.label>
