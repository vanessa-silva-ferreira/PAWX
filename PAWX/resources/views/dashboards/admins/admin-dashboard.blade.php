...
<div class="flex h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-white p-4 shadow-md">
        ...
        <nav class="space-y-4">
            <a href="#" class="flex items-center p-2 rounded-lg bg-gray-200 text-gray-700">
    ...
    <aside class="w-72 bg-white p-4 shadow-md flex flex-col items-center">
        ...
        <div class="flex items-center space-x-4">
            ...
            <form action="{{ url('logout') }}">
                @csrf
                <button type="submit" class="flex items-center px-3 py-2 text-gray-600 hover:text-gray-800">
