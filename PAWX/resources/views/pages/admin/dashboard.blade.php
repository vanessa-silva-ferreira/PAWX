...
@section('content')
    ...
    <div class="mt-10 md:ml-10 md:mr-10 mb-10">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            {{--        <h1 class="text-2xl font-bold text-pawx-brown uppercase mb-6">Olá, {{ Auth::user()->name }}</h1>--}}
                ...
                <div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 sm:gap-6 auto-rows-min">
                        <div
                            ...
                            <div
                                class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-full text-stone-500 ml-4">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                     stroke-linejoin="round" class="lucide lucide-piggy-bank">
                                    <path
