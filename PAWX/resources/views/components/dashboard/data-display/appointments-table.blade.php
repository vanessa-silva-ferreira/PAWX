...
{{--            </div>--}}
            ...
            <div class="mb-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-lg font-semibold text-stone-700">Agendamentos</h1>

                    <form method="GET" action="{{ route('admin.appointments.index') }}" class="flex items-center space-x-4">
                        <div class="relative flex-grow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="absolute left-3 top-1/2 transform -translate-y-1/2 text-stone-500">
                                <circle cx="11" cy="11" r="8"/>
                                <line x1="21" x2="16.65" y1="21" y2="16.65"/>
                            </svg>
                            <input
                                type="text"
                                name="search"
                                placeholder="Procurar por agendamento..."
            ...
            <table class="table w-full">
                ...
                @foreach ($appointments as $appointment)
                    <tr class="hover:bg-pawx-brown/5 text-pawx-brown/80">
