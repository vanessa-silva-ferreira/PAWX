    <div class="mx-10 my-10 bg-white">
        ...
        <div class="container mx-auto p-6">
            ...
            <div class="flex items-center justify-between mb-10 space-x-4">
                <form method="GET" action="{{ route('admin.clients.index') }}" class="flex w-full max-w-full">
                    ...
                    @foreach ($clients as $client)
                        <tr class="hover:bg-stone-100 text-stone-700">
                            ...
                            <td class="flex space-x-1">
                                <a href="{{ route('admin.clients.show', $client->client->id) }}" class="text-stone-400 hover:text-blue-800" title="View">
                                ...
                                <a href="{{ route('admin.clients.edit', $client->client->id) }}" class="text-stone-400 hover:text-yellow-800" title="Edit">
