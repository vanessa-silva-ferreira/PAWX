                ...
                @foreach ($clients as $client)
                    <tr class="hover:bg-stone-100 text-stone-700">
                        ...
                        <td class="flex space-x-1">
                            <a href="{{ route($rolePrefix . '.clients.show', $client->client->id) }}" class="text-stone-400 hover:text-blue-800" title="View">
                            ...
                            <a href="{{ route($rolePrefix . '.clients.edit', $client->client->id) }}" class="text-stone-400 hover:text-yellow-800" title="Edit">
