...
<div id="notificationSection" class="bg-white rounded-lg shadow-md p-6 w-full mt-4 hidden">
    ...
    <div class="flex items-center space-x-2">
        ...
        />
        <a
            href="<?php echo e(route('admin.appointments.create')); ?>"
            id="addNotification"
...
<?php /**PATH /home/vanessa-ferreira/Desktop/M-/PAWX/resources/views/partials/dashboard/notification-bar.blade.php ENDPATH**/ ?>