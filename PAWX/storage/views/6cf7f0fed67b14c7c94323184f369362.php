...
<div class="mx-10 my-10 bg-white">
    <div class="container mx-auto p-6">
        ...
        <div class="flex items-center justify-between mb-10 space-x-4">
            <form method="GET" action="<?php echo e(route($rolePrefix . '.pets.index')); ?>" class="flex w-full max-w-full">
            ...
            <a
                href="<?php echo e(route($rolePrefix . '.pets.create')); ?>"
        ...
        <div class="overflow-x-auto">
            <table class="table w-full">
                ...
                <?php $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-stone-100 text-stone-700 cursor-pointer" onclick="window.location='<?php echo e(route($rolePrefix . '.pets.show', $pet->id)); ?>';">
                        <th><?php echo e($pet->id); ?></th>
                        <td>
                            <div class="flex items-center gap-8">
                                <div class="avatar">
                                    <div class="mask mask-circle h-16 w-16">
                                        <img
                                            src="<?php echo e($pet->photo_url ?? 'https://images.pexels.com/photos/20787/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'); ?>"
                                            alt="Foto"/>
                                    </div>
                                </div>
                                <div>
                                    <div class="font-bold"><?php echo e($pet->name); ?></div>
                                    <div class="text-sm opacity-50 flex items-center gap-2">
                                        <span><?php echo e($pet->breed->species->name ?? 'N/A'); ?> - <?php echo e($pet->breed->name ?? 'N/A'); ?></span>
                        ...
                        <td><?php echo e($pet->size->category ?? 'N/A'); ?></td>
                        <td>
                            <?php if($pet->birthdate): ?>
                                <?php echo e(\Carbon\Carbon::parse($pet->birthdate)->age); ?> anos
                            <?php else: ?>
                                N/A
                            <?php endif; ?>
                        </td>
                        <td>
                            <a href="<?php echo e(route($rolePrefix . '.clients.show', $pet->client->id)); ?>"
                               class=" hover:underline" title="View">
                                <?php echo e($pet->client->user->name); ?>

                            </a>
                        </td>
                        <td class="px-1">
                            <a href="<?php echo e(route($rolePrefix . '.pets.edit', $pet->id)); ?>"
                        ...
                        <td class="px-1">
                            <a href="<?php echo e(route($rolePrefix . '.pets.show', $pet->id)); ?>"
...
<?php /**PATH /home/vanessa-ferreira/Desktop/M-/PAWX/resources/views/components/dashboard/data-display/pets-table.blade.php ENDPATH**/ ?>