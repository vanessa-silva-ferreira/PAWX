...
<div class="mx-10 my-10 bg-white">
    <div class="container mx-auto p-6">
        ...
        <div class="flex items-center justify-between mb-10 space-x-4">
            <form method="GET" action="<?php echo e(route($rolePrefix . '.clients.index')); ?>" class="flex w-full max-w-full">
            ...
            <a
                href="<?php echo e(route($rolePrefix . '.clients.create')); ?>"
            ...
            <table class="table w-full">
                ...
                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-stone-100 text-stone-700">
                        <th><?php echo e($client->client->id); ?></th>
                        <td><?php echo e($client->name); ?></td>
                        <td><?php echo e($client->email); ?></td>
                        <td><?php echo e($client->phone_number); ?></td>
                        <td><?php echo e($client->address); ?></td>
                        <td class="px-2">
                            <a href="<?php echo e(route($rolePrefix . '.clients.edit', $client->client->id)); ?>" class="text-stone-400 hover:text-blue-800" title="View">
                        ...
                        <td class="px-2">
                        <a href="<?php echo e(route($rolePrefix . '.clients.show', $client->client->id)); ?>" class="text-stone-400 hover:text-yellow-800" title="Edit">
                        ...
                        <?php if(auth()->user()->hasRole('admin')): ?>
                            <td class="px-2">
                                <form method="POST" action="<?php echo e(route($rolePrefix . '.clients.destroy', $client->client->id)); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/vanessa-ferreira/Desktop/M-/PAWX/resources/views/components/dashboard/data-display/clients-table.blade.php ENDPATH**/ ?>