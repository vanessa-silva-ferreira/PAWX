...
<header class="bg-white text-gray-800 p-4 lg:p-6 flex flex-row justify-between items-center shadow-md">
    ...
    <nav class="flex flex-wrap justify-center space-x-4 lg:space-x-6 text-sm lg:text-lg font-semibold">
        <a href="<?php echo e(route('welcome')); ?>" class="hover:text-gray-500">Home</a>
        <a href="<?php echo e(route('services')); ?>" class="hover:text-gray-500">Services</a>
...
<div class="bg-white p-4 lg:p-8 flex items-center justify-center">
    <div class="relative w-11/12 lg:w-9/12 overflow-hidden rounded-lg shadow-lg bg-gray-100">
        <div class="carousel-images flex transition-transform duration-500">
            <img src="<?php echo e(asset('images/pet1.jpg')); ?>" alt="Pet 1" class="object-cover">
            <img src="<?php echo e(asset('images/pet2.jpg')); ?>" alt="Pet 2" class="object-cover">
            <img src="<?php echo e(asset('images/pet3.jpg')); ?>" alt="Pet 3" class="object-cover">
            <img src="<?php echo e(asset('images/pet4.jpg')); ?>" alt="Pet 4" class="object-cover">
            <img src="<?php echo e(asset('images/pet5.jpg')); ?>" alt="Pet 5" class="object-cover">
            <img src="<?php echo e(asset('images/pet6.jpg')); ?>" alt="Pet 6" class="object-cover">
            <img src="<?php echo e(asset('images/pet7.jpg')); ?>" alt="Pet 7" class="object-cover">
            <img src="<?php echo e(asset('images/pet8.jpg')); ?>" alt="Pet 8" class="object-cover">
            <img src="<?php echo e(asset('images/pet9.jpg')); ?>" alt="Pet 9" class="object-cover">
            <img src="<?php echo e(asset('images/pet10.jpg')); ?>" alt="Pet 10" class="object-cover">
        </div>
    </div>
</div>
...
<?php /**PATH /home/vanessa-ferreira/Documents/Information Systems Technologies and Programming/Final Project/Projeto/PAWX/PAWX/resources/views/welcome.blade.php ENDPATH**/ ?>